...
*Algorithm Pseudocode from Proximal Policy Optimization OpenAI Paper (Schulman, et al.)*
...
*We observed colormap footage to qualitatively verify that our agent was aiming for blocks with a (162, 0, 93) RGB value.*
